...
for test in JsonTest ProviderFixtureTest TmdbFixtureTest M3uPlaylistTest M3uLiveProviderTest ExtractorFixtureTest DependencySmokeTest UserDataTest MpvPlayerTest PlaybackFallbackTest; do
